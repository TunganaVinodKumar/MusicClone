...
# Local:
#   Uses the development key below.
#
# Render:
#   Uses the DJANGO_SECRET_KEY environment variable.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "main.context_processors.music_context",
            ],
        },
    },
]
...
# MEDIA_URL and MEDIA_ROOT are defined unconditionally so that
# accessing settings.MEDIA_URL never raises an AttributeError.
MEDIA_URL = "/media/"
